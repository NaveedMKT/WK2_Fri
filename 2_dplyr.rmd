...
```{r exercise 01-6}
diamonds1 <- diamonds[,startsWith(names(diamonds),"c")]
```
...
```{r exercise 10-1}
msleep <- msleep %>% 
  mutate(ratio = sleep_total/bodywt)
view(msleep)
```
